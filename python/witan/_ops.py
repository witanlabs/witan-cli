...
OPERATIONS: tuple[OperationSpec, ...] = (
    ...
    OperationSpec("list_images", "listImages", (), ("sheet",)),
    OperationSpec("get_image", "getImage", ("sheet",), ("name", "id")),
    OperationSpec("add_image", "addImage", ("sheet", "image")),
    OperationSpec("set_image", "setImage", ("sheet", "image"), ("name", "id")),
    OperationSpec("delete_image", "deleteImage", ("sheet",), ("name", "id")),
