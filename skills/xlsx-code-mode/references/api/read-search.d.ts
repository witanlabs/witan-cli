...
declare function findCells(wb,matcher:Matcher,opts?:{in?:RangeRef|string;context?:number;limit?:number;offset?:number;formulas?:boolean}):Promise<Array<CellHit&{
	type:"cell";
	formula?:string;
	context?:string;
	role:string;
