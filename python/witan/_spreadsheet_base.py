...
def preview_data_url(result: Mapping[str, Any], operation: str) -> str:
...
def chart_selector_arg(chart: ChartSelector) -> JsonDict:
...
class _SpreadsheetSessionBase:
    ...
    def preview_styles(self, range: RangeRef, *, dpr: int | None = None, zoom: float | None = None, format: Literal["png", "webp"] | None = None) -> str:
        result = cast(Mapping[str, Any], self._request("preview_styles", "previewStyles", drop_none({"address": range, "dpr": dpr, "zoom": zoom, "format": format})))
        return preview_data_url(result, "previewStyles")
    ...
    def preview_chart(self, sheet: str, chart: ChartSelector, *, format: ChartPreviewFormat | None = None, dpr: int | None = None, zoom: float | None = None) -> str:
        args = drop_none({"sheet": sheet, **chart_selector_arg(chart), "format": format, "dpr": dpr, "zoom": zoom})
        result = cast(Mapping[str, Any], self._request("preview_chart", "previewChart", args))
        return preview_data_url(result, "previewChart")
...
class _AsyncSpreadsheetSessionBase:
    ...
    async def preview_styles(self, range: RangeRef, *, dpr: int | None = None, zoom: float | None = None, format: Literal["png", "webp"] | None = None) -> str:
        result = cast(Mapping[str, Any], await self._request("preview_styles", "previewStyles", drop_none({"address": range, "dpr": dpr, "zoom": zoom, "format": format})))
        return preview_data_url(result, "previewStyles")
    ...
    async def preview_chart(self, sheet: str, chart: ChartSelector, *, format: ChartPreviewFormat | None = None, dpr: int | None = None, zoom: float | None = None) -> str:
        args = drop_none({"sheet": sheet, **chart_selector_arg(chart), "format": format, "dpr": dpr, "zoom": zoom})
