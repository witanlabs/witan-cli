...
- Supported specs include combo charts, secondary axes, stock charts, bubble charts, radar charts, 2-D top-view surface charts, waterfall charts, histogram/Pareto charts, chart/plot-area formatting, group/series data labels, linked number formats, and style IDs. Use `previewStyles` after authoring to inspect rendered placement and labels.
...
interface ChartSpec {
	...
	position:ChartPosIn;
	groups:{
		type:"column"|"bar"|"line"|"area"|"pie"|"doughnut"|"scatter"|"bubble"|"radar"|"surface"|"stockHLC"|"stockOHLC"|"waterfall"|"histogram"|"pareto";
